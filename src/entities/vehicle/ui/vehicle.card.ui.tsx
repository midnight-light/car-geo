...
const VehicleCard = React.forwardRef<HTMLDivElement, VehicleCardProps>(({ vehicle, className, ...props }, ref) => {
    ...
    <Card ref={ref} className={cn('flex flex-col md:flex-row overflow-hidden', className)} {...props}>
      <div className="flex flex-col flex-grow">
        <div className="flex flex-row justify-between items-center">
          <Button size="icon" variant="ghost" className="text-red-500 hover:bg-red-500 hover:text-white [&_svg]:size-6">
            <TrashIcon />
          </Button>
          <Button
            size="icon"
